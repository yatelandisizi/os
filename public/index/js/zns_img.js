...
{
	var oImg = gethehe('img');
	var aImg = oImg.getElementsByTagName('img');
	var oPrev = gethehe('prev');
	var oPrev_div = gethehe('prevDiv');
	var oNext = gethehe('next');
	var oNext_div = gethehe('nextDiv');
	...
	{
		this.style.backgroundImage = 'url(/os/public/index/images/next.png)';
	...
	{
		this.style.backgroundImage = 'url(/os/public/index/images/prev.png)';
	...
	function prev(obj)
	{
		if(iNow==0)
		{
			obj.style.backgroundImage = 'url(/os/public/index/images/sm_0'+ (aImg.length) +'.jpg)';
		}
		else if(iNow==1)
		{
			obj.style.backgroundImage = 'url(/os/public/index/images/sm_0'+ (1) +'.jpg)';
		}
		else
		{
			obj.style.backgroundImage = 'url(/os/public/index/images/sm_0'+ (iNow) +'.jpg)';
		}
	}
	(function (){
	...
	function next(obj)
	{
		...
		{
			obj.style.backgroundImage = 'url(/os/public/index/images/sm_0'+ (2) +'.jpg)';
		}
		else
		{
			obj.style.backgroundImage = 'url(/os/public/index/images/sm_0'+ (iNow+2) +'.jpg)';
		}
	}
}